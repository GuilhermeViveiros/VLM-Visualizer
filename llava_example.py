...
#qwen_infer(
    #     "<image 1> The elliptical orbit of a planet around the Sun is shown on the diagram. Which of the following statements is true?\nA. the planet's orbit is a perfect circle\nB. the eccentricity of the orbit is greater than 1\nC. the eccentricity of the orbit is equal to 1\nD. the sun might be at point E\nE. the sun might be at point C\nF. the sun might be at point A\nG. the eccentricity of the orbit is less thatn zero\nH. the sun might be at point B\nI. the sun might be at point D\nJ. the eccentricity of the orbit is zero\n\nAnswer the following multiple choice question. The last line of your response should be of the following format: 'Answer: $LETTER' (without quotes) where LETTER is one of options. Think step by step before answering.",
    #     "/home/gviveiros/ai-coach/image_validation_Physics_7_0.png",
    # )
#image_path_or_url = "../LLaVA-NeXT/image_validation_Physics_7_01.png"
#prompt_text = "<image> The elliptical orbit of a planet around the Sun is shown on the diagram. Which of the following statements is true?\nA. the planet's orbit is a perfect circle\nB. the eccentricity of the orbit is greater than 1\nC. the eccentricity of the orbit is equal to 1\nD. the sun might be at point E\nE. the sun might be at point C\nF. the sun might be at point A\nG. the eccentricity of the orbit is less thatn zero\nH. the sun might be at point B\nI. the sun might be at point D\nJ. the eccentricity of the orbit is zero\n\nAnswer the following multiple choice question. The last line of your response should be of the following format: 'Answer: $LETTER' (without quotes) where LETTER is one of options. Think step by step before answering."
...
print("Number of heads: ", len(outputs.attentions[0][0]))
print("Shape of attention matrix: ", outputs["attentions"][0][0].shape)
...
vis_attn_matrix = aggregate_vit_attention(
    model.get_vision_tower().image_attentions, # [1, num_heads, seq_len, seq_len] -> attn[0] -> input attn
...
for i, ax in enumerate(axes.flatten()):
    ...
    token_text = tokenizer.decode(outputs["sequences"][0][i], add_special_tokens=False).strip()
